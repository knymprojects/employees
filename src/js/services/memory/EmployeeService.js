...
export default class EmployeeService {
    ...
    deleteEmployee = (id) => {
        ...
        if (employeeIndex !== -1) { // Check if employee with given id exists
            this.employees.splice(employeeIndex, 1); // Remove the employee at found index
            return true; // Return true indicating successful deletion
        }
        return false; // Return false indicating failure to delete (employee not found)
    }
}